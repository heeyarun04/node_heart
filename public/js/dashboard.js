(function($) {
  ...
  $(function() {
    if ($("#order-chart").length) {
      var areaData = {
        labels: ["14:05","14:06","14:07","14:08","14:09",],
        datasets: [{
              label: 'Detak Jantung',
              data: [110, 80, 90, 99, 100],
    ...
    if ($("#north-america-chart").length) {
     var areaData = {
        labels: ["14:05","","","20","","","30","","","40","","", "50","","", "60","","","70"],
        datasets: [
          {
            data: [200, 480, 700, 600, 620, 350, 380, 350, 850, "600", "650", "350", "590", "350", "620", "500", "990", "780", "650"],
            borderColor: [
          ...
          {
            data: [302, 232, 544, 121, 552, 323, 543, 232, 343, "292", "652", "433", "454", "232", "454", "565", "400", "323", "545"],
            borderColor: [
              '#57B657'
            ],
            borderWidth: 2,
  ...
  if ($("#radarChart").length) {
        var SalesChartCanvas = $("#radarChart").get(0).getContext("2d");
      var SalesChart = new Chart(SalesChartCanvas, {
        type: 'bar',
        data: {
          labels: ["Jan", "Feb", "Mar", "Apr", "May"],

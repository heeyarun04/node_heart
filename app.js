...
app.get('/get-jadwal/:id', require("./controller/response").getJadwalById);
// Endpoint untuk memperbarui jadwal berdasarkan ID
app.put('/up-jadwal/:id', require("./controller/response").updateJadwal);
// Endpoint untuk menghapus jadwal berdasarkan ID
app.delete('/del-jadwal/:id', require("./controller/response").deleteJadwal);
